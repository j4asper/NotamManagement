...
namespace NotamManagement.Api.Extensions;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : User, new()
    {
        ...
        routeGroup.MapPost("/register", async Task<Results<Ok<AccessTokenResponse>, ValidationProblem>>
     ([FromBody] RegisterDTO registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                await userManager.AddClaimAsync(user, new Claim("OrganizationId", registration.OrganizationId.ToString()));
            }
            ...
            {
                AccessToken = token,
                ExpiresIn = 3600 // Set expiration in seconds
            });
        });
